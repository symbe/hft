...
class MyWindow(QMainWindow):
    ...
    def btn4_clicked(self):
        ...
        ret = self.api.dynamicCall("DoRequestData(int, QString, QString, QString, QString)", -1, "DSBB010030", strInput, "", "")
    ...
    def btn5_clicked(self):
        ...
        Qs = ""
        str1 = ["2", "08717010", pw, "167QC000", "1", "1", "2", "1", now, Qs]
    ...
    def btn6_clicked(self):
        ...
        now = self.api.dynamicCall("GetDataAt(QString, int, int, int)", "PIBO1001", 1, 0, 5)  # 현재가
        Qs = ""
        str2 = ["2", "08717010", pw, "167QC000", "2", "1", "2", "1", now, Qs]
        # 주야간 구분, 계좌번호, 비밀번호, 종목, 매매구분, 가격조건, 체결조건, 주문수량, 주문가격, 사용자정의 문자열
        self.api.dynamicCall(
            "DoRequestDomNewOrder(Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring)",
            str2)
    ...
    def event_receivedata(self, DataSeq, TrCode, ErrCode, quote):
        ...
        if TrCode == "DSBB010030":
            ...
            for i in range(0, nRow):
                ...
                now = self.api.dynamicCall("GetDataAt(QString, int, int, int)", "PIBO1001", 1, 0, 5)  # 현재가
                num = self.api.dynamicCall("GetDataAt(QString, int, int, int)", "DSBB010010", 1, i, 4)  # 주문번호

                end = [[pss, qtt, prs, now, num] for row in range(nRow)]
            ...
            # 현재가 평단에서 5틱 초과
                ...
                if (float(end[i][2]) + 0.05) < float(end[i][3]):

                    # 현재 포지션 매수 시
                    if end[i][0] == "1":

                        pw = self.api.dynamicCall("GetEncodeText(Qstring)", "6644")
                        nw = float(end[i][3]) - 0.01
                        qt = int(end[i][1])

                        # 전량 익절 매도
                        str1 = ["2", "08717010", pw, "167QC000", "2", "1", "1", qt, nw, ""]
                        self.api.dynamicCall(
                            "DoRequestDomNewOrder(Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring)",
                            str1)

                        print("Long Take Profit /", "Long at", end[i][2], "and NOW:", end[i][3])
                    ...
                    # 현재 포지션 매도 시
                        ...
                        # 전량 익절 매도
                        str1 = ["2", "08717010", pw, "167QC000", "1", "1", "1", qt, nw, ""]
                        self.api.dynamicCall(
                            "DoRequestDomNewOrder(Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring)",
                            str1)

                        print("Short Stop Loss /", "Short at", end[i][2], "and NOW:", end[i][3])
                ...
                if (float(end[i][2]) - 0.05) > float(end[i][3]):
                    ...
                    if end[i][0] == "1":
                        ...
                        print("Long Stop Loss /", "Long at", end[i][2], "and NOW:", end[i][3])
                    ...
                    # 현재 포지션 매도 시
                        ...
                        print("Short Take Profit /", "Short at", end[i][2], "and NOW:", end[i][3])
    ...
    def event_receivereal(self, RealCode, RealKey, UserArea):
        ...
        for j in range(g_nBufCol):
            ...
            pw = self.api.dynamicCall("GetEncodeText(Qstring)", "6644")
            strr = "08717010   " + pw
            ret = self.api.dynamicCall("DoRequestData(int, QString, QString, QString, QString)", -1, "DSBB130601", strr, "", "")
            quantity = self.api.dynamicCall("GetDataAt(QString, int, int, int)", "DSBB130601", 1, 0, 5)  # 수량
            ...
            and quote.now == quote.ask_price):
                ...
                pw = self.api.dynamicCall("GetEncodeText(Qstring)", "6644")
                # 매도호가에서 매수
                str1 = ["2", "08717010", pw, "167QC000", "1", "1", "1", "2", bidpoint, ""]
                self.api.dynamicCall(
                ...
                and quote.now == quote.bid_price ):
                    ...
                    # 매수호가에서 매도
                    str3 = ["2", "08717010", pw, "167QC000", "2", "1", "1", "2", askpoint, ""]
                    self.api.dynamicCall(
                        "DoRequestDomNewOrder(Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring)",
                        str3)
            ...
            #총매도 소폭 우위
                ...
                and quote.now == quote.bid_price ):
                    ...
                    # 매수호가에서 매도
                    str1 = ["2", "08717010", pw, "167QC000", "2", "1", "1", "2", askpoint, ""]
                    self.api.dynamicCall(
                    "DoRequestDomNewOrder(Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring)",
                    str1)
                ...
                and quote.now == quote.ask_price ):
                    ...
                    # 매도호가에서 매수
                    str3 = ["2", "08717010", pw, "167QC000", "1", "1", "1", "2", bidpoint, ""]
                    self.api.dynamicCall(
                        "DoRequestDomNewOrder(Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring, Qstring)",
                        str3)
